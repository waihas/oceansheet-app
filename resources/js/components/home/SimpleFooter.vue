<template>
    <footer class="text-gray-600 bg-gray-100">
        <div class="container px-5 py-4 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2022 OceanSheet —
                <a href="https://oceansheet.com" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@oceansheet</a>
            </p>
