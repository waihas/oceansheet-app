...
@section('title', 'For Google Sheet')
        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="text-center mb-20">
                <h1 class="sm:text-5xl text-3xl font-medium text-gray-900 mb-4">
                    OceanSheet For Google Sheets
                </h1>
                <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
                    Collect, sync and filter your data — all within Google Sheets. OceanSheet add-on for Google Sheets enables hassle free, no-code data management.
                </p>
            ...
            <div class="flex flex-wrap -m-4">
                ...
                <div class="xl:w-1/3 md:w-1/2 p-4">
                    <div class="border border-gray-200 p-6 rounded-lg">
                        ...
                        <p class="leading-relaxed text-base">
                            OceanSheet connect for Google Sheets lets you collect data from multiple different sources. Bring all the data you need into one convenient list.
                        </p>
                    </div>
                </div>
                <div class="xl:w-1/3 md:w-1/2 p-4">
        ...
        <div class="container px-5 py-24 mx-auto flex flex-col">
            <div class="lg:w-4/6 mx-auto">
                <div class="rounded-lg h-auto overflow-hidden">
                    <img alt="OceanSheet For Google Sheet" class="object-cover object-center h-full w-full" src="/assets/img/for-gsheet.jpg">
                </div>
