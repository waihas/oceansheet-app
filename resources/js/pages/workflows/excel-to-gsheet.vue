    ...
    <div>
        <section class="text-gray-600">
            <div class="container px-5 py-24 mx-auto">
                <div class="text-center mb-20">
                    <h1 class="sm:text-3xl text-2xl font-medium text-gray-900 mb-4">From Excel To Google Sheet</h1>
        ...
        <section class="text-gray-600">
            <div class="container px-5 py-24 mx-auto flex flex-wrap flex-col">
                ...
                <a class="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 font-medium bg-gray-100 inline-flex items-center leading-none border-main-500 text-main-500 tracking-wider rounded-t">
                ...
                <a class="sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 font-medium inline-flex items-center leading-none border-gray-200 hover:text-gray-900 tracking-wider">
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5 mr-3" viewBox="0 0 24 24">
                    <path d="M22 12h-4l-3 9L9 3l-3 9H2"></path>
                    </svg>STEP 2
                </a>
                ...
                <h1 class="text-xl font-medium mb-4 text-gray-900">Master Cleanse Reliac Heirloom</h1>
