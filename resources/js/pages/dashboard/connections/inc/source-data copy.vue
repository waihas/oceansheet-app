...
// var CLIENT_ID = "727914357338-l3hhcebf48cfesv4r2733vpjia40l8ft.apps.googleusercontent.com";
// var API_KEY = "AIzaSyDnUBzVRUIu2DFA9NE28Fbqru7Q5dei4Pw";
// var DISCOVERY_DOCS = ["https://content.googleapis.com/discovery/v1/apis/drive/v3/rest"];
    ...
    methods: {
        ...
        updateSigninStatus(isSignedIn) {
             if (isSignedIn) {
                ...
                // showLoading();
                // getDriveFiles();
                console.log('HE IS SIGNED');
                this.loadClient();
            } else {
                console.log('HE IS NOT SIGNED');
...
//         }
//     ],
//     "spreadsheetUrl": "https://docs.google.com/spreadsheets/d/1sdxqzuQ7fANcYUJjbnFJ0YCpHZqWH9gBCxcT-0M9vTY/edit"
// }
