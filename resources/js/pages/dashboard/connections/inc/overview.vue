<template>
    <div class="flex flex-col md:col-span-3 md:row-span-2 bg-white rounded-lg">
        <div class="px-6 py-5 font-semibold border-b border-gray-100">Connection overview</div>
