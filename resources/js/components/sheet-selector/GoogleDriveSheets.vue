                        ...
                        <div class="mt-12 mb-4">
                            <div class="w-full border-b pb-5">
                                ...
                                <div v-else class="flex flex-col w-full group border rounded bg-gray-100 hover:border-main-300">
                                    <div class="flex bg-blue-100 p-4 text-sm text-blue-700 items-center" role="alert">
                                        <svg class="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>
                                        <div>
                                            <span class="font-bold">Dear friend!</span> Google is still verifying our application. In the meantime, you would see security alerts, but no worries, we don't copy any of your files, we just connect them.
                                        </div>
                                    </div>
                                    <div class="flex flex-col items-center justify-center py-7">
                                        <UploadIcon/>
